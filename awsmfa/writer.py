...
# borrow from 'https://github.com/aws/aws-cli/blob/develop/awscli/customizations/configure/writer.py'
class ConfigFileWriter(object):
    ...
    def _find_section_start(self, contents, section_name):
        for i in range(len(contents)):
            ...
            if match is not None and self._matches_section(match, section_name):
                return i
